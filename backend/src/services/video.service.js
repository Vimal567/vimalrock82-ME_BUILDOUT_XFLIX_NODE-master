...
const getVideos = async (title, contentRating, genres, sortBy) => {
    ...
    const contentRantingMatch = { contentRating: { $in: contentRatings}};
...
//This function sorts the videos either by release date or view counts
...
const addVideo = async(videoBody) => {
    const video = Video.create(videoBody)
    .catch( error => {
